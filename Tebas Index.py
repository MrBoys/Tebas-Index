...
echo $yellow
figlet -f future "Indonesian Cyber Team"
echo
echo $red"##########################$green" WELCOME "$red###########################"
echo
...
echo $indigo"=============================================================="
echo
echo $white "╭─"$yellow"WING ON CYBER"$cyan" ~/MRBOYS"$white
read -p " ╰─$ "  apaan
echo
if [ $apaan = "A" ] || [ $apaan = "a" ]
then
...
echo $green "╭─"$blue"WING ON CYBER"$cyan" ~/Nama SC Harus(index.html)"$white
read -p " ╰─$ "  script
...
echo
echo "Masukan Script !!!!"
echo $white "╭─"$green"WING ON CYBER"$cyan" ~/MRBOYS"$white                               
read -p " ╰─$ " script
echo
echo
echo $white"Masukan Target1 !!!!"
echo $white "╭─"$green"WING ON CYBRR"$cyan" ~/Crot"$white
read -p " ╰─$ " target1
...
echo $white "╭─"$green"WING ON CYBER"$cyan" ~/Crot"$white
read -p " ╰─$ " target3
...
echo $white "╭─"$green"WING ON CYBER"$cyan" ~/MR BOYS"$white
read -p " ╰─$ " target11
...
echo
echo $red"##########################$green" WELCOME "$red###########################"
echo $green"Author  : MR BOYS     "
echo $purple"Github   : https://github.com/MrBoys"   
echo $yellow"                          THANKS TO :"
echo
echo $cyan"[+] PaTrickCupuu"
echo $cyan"[+] NDARU "
echo $cyan"[+] All Member [W.O.C] "
echo $red"##########################$green" WELCOME "$red###########################"
